...
export default function LoginPage(){
    ...
    return(
        <div className="w-[100%] h-[100vh] flex flex-col items-center justify-center gap-[10px]">
            ...
            <div className="h bg-neutral-100 drop-shadow-2xl flex flex-col w-[20%] min-w-[400px] items-center py-5 gap-[5px] rounded-lg">
                ...
                <input type='text' placeholder="Numele de utilizator" className="min-w-[200px] w-[90%] h-[50px] p-[5px] text-black focus:outline-0 border-2 border-neutral-200 rounded-lg text-lg"></input>
                <input type='password' placeholder="Parola" className="min-w-[200px] w-[90%] h-[50px] p-[5px] text-black focus:outline-0 border-2 border-neutral-200 rounded-lg text-lg"></input>
